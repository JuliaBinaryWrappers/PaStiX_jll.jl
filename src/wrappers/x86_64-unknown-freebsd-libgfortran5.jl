# Autogenerated wrapper script for PaStiX_jll for x86_64-unknown-freebsd-libgfortran5
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, METIS_jll, Hwloc_jll, OpenBLAS32_jll)
